...
#    Updated: 2019/03/08 20:49:03 by mirivera         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_memccpy.c ft_memset.c ft_putnbr_fd.c ft_strcmp.c ft_striteri.c ft_strncat.c ft_strrchr.c ft_toupper.c get_next_line.c \
...
ft_memccpy.o ft_memset.o ft_putnbr_fd.o ft_strcmp.o ft_striteri.o ft_strncat.o ft_strrchr.o ft_toupper.o get_next_line.o \
